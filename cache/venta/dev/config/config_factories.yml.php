...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/facturacion/log/venta_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/facturacion/cache/venta/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/facturacion/apps/venta/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/facturacion/cache/venta/dev/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/facturacion/apps/venta/template',
)));
