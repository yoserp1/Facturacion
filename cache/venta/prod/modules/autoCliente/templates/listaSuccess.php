...
//    height:550,
    ...
    {header: 'Tx dni', width:100,  menuDisabled:true, sortable: true,  dataIndex: 'tx_dni'},
    {header: 'Tx nombre', width:100,  menuDisabled:true, sortable: true,  dataIndex: 'tx_nombre'},
    {header: 'Tx direccion', width:100,  menuDisabled:true, sortable: true,  dataIndex: 'tx_direccion'},
    {header: 'Tx telefono', width:100,  menuDisabled:true, sortable: true,  dataIndex: 'tx_telefono'},
    {header: 'Nu limite credito', width:100,  menuDisabled:true, sortable: true,  dataIndex: 'nu_limite_credito'},
    ],
    stripeRows: true,
    autoScroll:true,
    stateful: true,
