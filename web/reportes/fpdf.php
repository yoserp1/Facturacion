 ...
 * @param string $data ....
 * @param int $borde Valor por defecto 0. Especifica un borde solid
 * @param int $pintar Valor por defecto 0. indica que la fila aceptara color.
 *
 * 
 */
function Row($data,$borde=0,$pintar=0)
{
    ...
    for($i=0;$i<count($data);$i++)
    {
        ...
        $this->Rect($x,$y,$w,$h);
        //Print the text
        $this->MultiCell($w,5,$data[$i],$borde,$a,$pintar);
...
class RPDF extends PDF_Code128 {
