 ...
 */
class captcha extends sfActions
{
	/**
	...
	*/
	...
	var $font = '/var/www/facturacion/web/captcha/captcha.ttf';
	...
	public function captcha($width='120',$height='40',$characters='6') {
		...
		imagejpeg($image);
		imagedestroy($image);
		$_SESSION['codigo_seguridad'] = $code;
//		$this->getUser()->setAttribute('codigo_seguridad', $code);
